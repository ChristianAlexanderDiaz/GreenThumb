...
//}
//
//public func getPlantDetailsFromApi(plantId: Int) {
//    let apiUrlStringAttributes = "https://perenual.com/api/species/details/\(plantId)?key=\(perenualApiKey)"
//
//    var jsonDataFromAttributesApi: Data
//
//    let jsonDataFetchedFromAttributesApi = getJsonDataFromApi(apiHeaders: perenualApiHeaders, apiUrl: apiUrlStringAttributes, timeout: 20.0)
...
//            indoor = plant["indoor"] as? Bool ?? false
//
//            let newPlant = PlantAPIStruct(id: Int32(plantId), common_name: common_name, scientific_name: scientific_name, other_name: other_name, cycle: cycle, watering: watering, sunlight: sunlight, thumbnail: thumbnail, attracts: attracts, type: type, dimension: dimension, indoor: indoor)
//            foundPlantDetails.append(newPlant)
//        }
//    } catch { return }
//}
